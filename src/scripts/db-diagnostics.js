// File: src/scripts/db-diagnostics-common.js
// This file uses CommonJS and should be run with node directly
/* eslint-disable */
...
// node ./src/scripts/db-diagnostics-common.js
...
async function testDbConnection() {
  ...
  • SSL Required: ${parsedUrl.searchParams.has('sslmode')}
    ...
    const portTest = new Promise((resolve, reject) => {
      ...
      // Use a function call to avoid expression issues
      const _ = socket.connect(parseInt(port), host);
    });
