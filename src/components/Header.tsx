...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="bg-blue-600 text-white text-center py-2 px-4 font-medium">
        <Container>
          <p className="text-sm md:text-base animate-pulse">
            🚀 <span className="font-bold">BETA VERSION</span> - Smart Practise is undergoing constant improvements and nearing launch! 🚀
          </p>
        </Container>
      </div>
